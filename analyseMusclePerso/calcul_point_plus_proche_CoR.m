function [pt] = calcul_point_plus_proche_CoR(P1_m,P2_m,P_Cor)
...
% New version à verifier résolution analytique déjà faites
t_pt = ( (N(1)*P_Cor(1)+N(2)*P_Cor(2)+N(3)*P_Cor(3)) - (N(1)*P1_m(1)+N(2)*P1_m(2)+N(3)*P1_m(3)) )...
     / ( N(1)^2 +N(2)^2 +N(3)^2);
 
 
% t_pt = solve(eq_pt,t); %Old version
