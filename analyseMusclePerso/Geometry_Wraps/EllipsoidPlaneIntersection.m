function[Aye,Bye,q1,q2,q3,angle]=EllipsoidPlaneIntersection(A,B,C,D,a,b,c)
...
%
% Outputs ----------------------------------------------------------------
%   Aye:  Semi-major axtis of intersection ellipse
...
if C==0 && A~=0
    ParA=[(1/b^2 + (B/A/a)^2) 0  1/c^2 (2*D*B/(A*a)^2)  0  (-1+(D/A/a)^2)];
    G=AtoG(ParA);
...
if C==0 && B~=0
    ParA=[(1/a^2 + (A/B/b)^2) 0  1/c^2 (2*D*A/(B*b)^2)  0  (-1+(D/B/b)^2)];
    G=AtoG(ParA);
    q1=G(1);
    q3=G(2);
    q2=(D+A*q1+C*q3)/-B;
