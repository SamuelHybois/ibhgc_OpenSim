function IK = setup_InverseKinematics(varargin)%(tolerance_contrainte_ik,varargin)
...
V.ATTRIBUTE.Version = '30000';%'20302';maj DianeH09/2018
...
V.InverseKinematicsTool.marker_file = fullfile(InputDirectory, MarkerFile); % modif jba: le chemin relatif n'était pas pris en compte
...
% modifications décembre 2016 (Maxime Bourgain)
V.InverseKinematicsTool.report_marker_locations = 'true';

% fileout = [data.Name '_Setup_InverseKinematics.xml'];
fileout = fullfile(ResultsDirectory , [MarkerFile(1:end-4), '_Setup_IK.xml']);
