function [ MH_tib, pt_malleole ] = calcul_repere_tibia_mod_avec_malleoles_decal( file_wrl_tibia , region_tibia,decal_EOS_cond_lat,decal_EOS_cond_med )
...
pt_tib.lat = barycentre(PlateauExt.Noeuds)+decal_EOS_cond_lat';
pt_tib.med = barycentre(PlateauInt.Noeuds)+decal_EOS_cond_med';
