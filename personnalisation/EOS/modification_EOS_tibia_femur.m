function [model_new,MH_R0Rlocal_femur_2,MH_R0Rlocal_tibia_2]=modification_EOS_tibia_femur(model_new,file_wrl_tibia,file_ddr_tibia,file_wrl_femur,file_ddr_femur,nb_femur,nb_tibia,nb_talus,nb_patella,cote)
