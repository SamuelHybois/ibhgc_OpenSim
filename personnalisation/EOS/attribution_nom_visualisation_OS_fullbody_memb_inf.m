function [ Bodies ] = attribution_nom_visualisation_OS_fullbody_memb_inf( folder_geo,cur_sujet )
% Maxime Bourgain
% 13/12/2016
% table des correspondances EOS / OpenSim


%MAJ pour ne prendre en compte que les segments qui peuvent être
%personnalisés avec EOS actuellement (2017)
%% ground
Bodies.ground={};
...
% geo_OS_C1{1}='C1.vtp';
% [Bodies.cerv1]=association_EOS_OS(folder_geo,geo_EOS_C1,geo_OS_C1);
% 
% geo_EOS_C2{1}=[cur_sujet '_Vertebre_C2.stl'];
% geo_OS_C2{1}='C2.vtp';
% [Bodies.cerv2]=association_EOS_OS(folder_geo,geo_EOS_C2,geo_OS_C2);
% 
% geo_EOS_C3{1}=[cur_sujet '_Vertebre_C3.stl'];
% geo_OS_C3{1}='C3.vtp';
% [Bodies.cerv3]=association_EOS_OS(folder_geo,geo_EOS_C3,geo_OS_C3);
% 
% geo_EOS_C4{1}=[cur_sujet '_Vertebre_C4.stl'];
% geo_OS_C4{1}='C4.vtp';
% [Bodies.cerv4]=association_EOS_OS(folder_geo,geo_EOS_C4,geo_OS_C4);
% 
% geo_EOS_C5{1}=[cur_sujet '_Vertebre_C5.stl'];
% geo_OS_C5{1}='C5.vtp';
% [Bodies.cerv5]=association_EOS_OS(folder_geo,geo_EOS_C5,geo_OS_C5);
% 
% geo_EOS_C6{1}=[cur_sujet '_Vertebre_C6.stl'];
% geo_OS_C6{1}='C6.vtp';
% [Bodies.cerv6]=association_EOS_OS(folder_geo,geo_EOS_C6,geo_OS_C6);
% 
% geo_EOS_C7{1}=[cur_sujet '_Vertebre_C7.stl'];
% geo_OS_C7{1}='C7.vtp';
% [Bodies.cerv7]=association_EOS_OS(folder_geo,geo_EOS_C7,geo_OS_C7);
...
% Bodies.skull{1}='skull.vtp';%Bodies.head{1}='skull.vtp';
