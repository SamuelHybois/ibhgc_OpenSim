...
%
function [model_new, reperesH]=GOLF_personnalisation_EOS_decalage_2_pour_pipeline(model_old,repertoire_wrl_EOS, Protocol, sexe, repertoire_ddr, decalage_in_bassin,rep_geo,cur_sujet)%,marqueurs)
...
%%% attention si fullbody ou non
[ Bodies ] = attribution_nom_visualisation_OS_fullbody( rep_geo,cur_sujet )
...
for i=1:nb_bodies
    ...
    if isfield(Bodies.(cur_nom),'visualisation')
        body_visu=Bodies.(cur_nom).visualisation;
