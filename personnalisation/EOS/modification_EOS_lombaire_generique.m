function [model_new,MH_R0Rlocal_courant]=modification_EOS_lombaire_generique(model_new,file_wrl_courante,file_ddr_courante,nb_courante,MH_R0local_Rparent)
...
[MH_R0Rlocal_Li, centre_sup_Li, centre_inf_Li, centre_pedicule_d, centre_pedicule_g]=calcul_repere_lombaire(file_wrl_courante,file_ddr_courante);
MH_R0Rlocal_courant=MH_R0Rlocal_Li;

if strcmp(model_new.Model.length_units,'meters')==1
    MH_R0Rlocal_courant(1:3,4)=MH_R0Rlocal_Li(1:3,4)*10^(-3);
    centre_sup_Li=centre_sup_Li/1000;
    centre_inf_Li=centre_inf_Li/1000;
...
elseif strcmp(model_new.Model.length_units,'milimeters')==1
    centre_inf_Li=centre_inf_Li;
    centre_sup_Li=centre_sup_Li;
