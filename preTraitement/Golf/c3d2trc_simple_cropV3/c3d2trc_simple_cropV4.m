function c3d2trc_simple_cropV4(myc3d_path,st_marqueurs_cine,crop_inf, crop_sup, chemin_sortie)
% crop en frame vicon
...
ecriture_fich_trc_cropV2(VICON_cine,chemin_sortie,crop_inf,crop_sup);
